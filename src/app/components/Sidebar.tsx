      ...
      >
        <div className="flex flex-col h-full">
              ...
              {filteredMenuItems.map((item) => {
                ...
                return (
                  <li key={item.path}>
                    <button
                      onClick={() => handleNavigation(item.path)}
                      className={`w-full flex items-center gap-3 px-3 py-3 rounded-md transition min-h-[44px] group relative ${
                        active
          ...
          <div className="p-4 border-t border-border">
            <button
              onClick={() => setCollapsed(!collapsed)}
              className="flex items-center justify-center w-full h-10 rounded-md hover:bg-muted transition"
            >
              <Icon
                name={collapsed ? "ChevronRight" : "ChevronLeft"}
                size={20}
