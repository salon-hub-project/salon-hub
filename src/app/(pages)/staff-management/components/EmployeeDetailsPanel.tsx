        ...
        <div className="p-6 space-y-6">
          <div className="flex items-start gap-4">
            <div className="w-20 h-20 rounded-full overflow-hidden bg-muted flex-shrink-0">
              {employee.avatar ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-primary text-primary-foreground text-2xl font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                <h4 className="text-sm font-semibold text-foreground mb-3">Working Days</h4>
              ...
              <div>
                <h4 className="text-sm font-semibold text-foreground mb-3">Commission Rate</h4>
                <p className="text-2xl font-bold text-primary">{employee.commissionRate}%</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${Math.min((employee.performanceMetrics.completedServices / 100) * 100, 100)}%` }}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(employee.performanceMetrics.customerRating / 5) * 100}%` }}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm text-muted-foreground">Booking Completion</span>
                      <span className="text-sm font-medium text-foreground">
                    ...
                    <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${employee.performanceMetrics.bookingCompletionRate}%` }}
                      />
                    </div>
                  </div>
          ...
          <div>
            <h4 className="text-sm font-semibold text-foreground mb-3">Assigned Services</h4>
            <div className="flex flex-wrap gap-2">
